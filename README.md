...
- **Despesas recorrentes** — moldes mensais (renda, ginásio, subscrições…) que se repetem num dado dia do mês, com a mesma flexibilidade de divisão das despesas normais. Geridos no separador **Definições** do grupo. Não há servidor: são **lançados automaticamente** (a partir do dia marcado, ajustado ao último dia nos meses mais curtos) quando alguém abre a app — sem nunca duplicar, mesmo com várias pessoas a abrir ao mesmo tempo.
