...
- **Lançar uma despesa é um assistente** — o formulário abre a ecrã cheio no telemóvel e faz **uma pergunta de cada vez**: *quanto foi* → *em quê* → *quem pagou* → *por quem se divide* → *rever*. Botões e alvos de toque grandes (grelha de categorias com todas à vista, pessoas em cartões com avatar), uma barra de progresso no topo que salta para qualquer passo e um **resumo final** com tudo o que vai ser gravado — cada linha do resumo leva de volta ao passo respetivo. Ao abrir uma despesa já lançada entra-se logo pelo resumo.
