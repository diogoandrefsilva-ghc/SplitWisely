...
- **Lançar uma despesa em três campos** — o formulário abre a ecrã cheio no telemóvel com o essencial e nada mais: **descrição, valor, data** e **«Registar»**. A despesa fica em nome de quem a lança e divide-se pelo normal do grupo — o cartão diz por palavras o que vai assumir (quem pagou, por quantas pessoas se divide, a categoria sugerida pela descrição), por isso não há nada a adivinhar. Uma linha por baixo da data liga a **repetição mensal**, se for o caso.
- **«Mais detalhe» quando é preciso** — o segundo botão do cartão abre um **assistente de 5 passos** (despesa → categoria → quem pagou → divisão → rever), uma pergunta por ecrã, com alvos de toque grandes: grelha de categorias com todas à vista, pessoas em cartões com avatar e o valor de cada uma ao lado. A barra de progresso no topo salta para qualquer passo e o **resumo final** repete tudo o que vai ser gravado — cada linha leva de volta ao passo respetivo. Ao abrir uma despesa já lançada entra-se logo pelo resumo.
