...
- **Lançar uma despesa em três campos** — o formulário abre a ecrã cheio no telemóvel num cartão com o essencial e nada mais: **descrição, valor, data** e **«Registar»**. Os atalhos de data mostram-na («Hoje, 25/ago», «Ontem, 24/ago») e o seletor de outra data só aparece quando se pede. A despesa fica em nome de quem a lança e divide-se pelo normal do grupo — e o cartão mostra logo o **resumo do que vai ser gravado** (quem pagou, divisão, categoria sugerida pela descrição e quanto fica cada pessoa), por isso não há nada a adivinhar; tocar numa linha do resumo abre o detalhe já no sítio onde se muda.
- **«Mais detalhe» sem mudar de ecrã** — o segundo botão do cartão abre o resto da folha ali mesmo, por baixo: blocos numerados **sempre abertos** (categoria, quem pagou, como se divide) e a escolha de **repetição mensal**, sem separadores nem passos — rola-se e vê-se o formulário inteiro. Cada bloco mostra no cabeçalho o resumo do que já lá está, os alvos de toque são grandes (grelha de categorias, pessoas em cartões com avatar) e uma barra colada ao fundo resume o que vai ser gravado. Se faltar acertar alguma coisa, o bloco em causa fica assinalado a vermelho e a folha rola até lá.
